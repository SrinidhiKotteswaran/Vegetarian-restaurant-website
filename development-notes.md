...
<head>
  ...
  <!-- 
    - primary meta tags
  -->
  <title>Garam Gourmé</title>
  <meta name="title" content="Garam - Amazing & Delicious Food">
...
<body id="top">
  ...
  <div class="topbar">
    <div class="container">
      ...
      <a href="mailto:booking@restaurant.com" class="topbar-item link">
        ...
        <span class="span">garam@gourmé.com</span>
      </a>
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="index.html" class="logo">
        <img src="./assets/images/logos.svg" width="160" height="50" alt="Garam - Home">
      </a>
      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="About Us.html" class="navbar-link hover-underline">
              <div class="separator"></div>
          ...
          <li class="navbar-item">
            <a href="blog.html" class="navbar-link hover-underline active">
              <div class="separator"></div>
          ...
          <li class="navbar-item">
            <a href="#" class="navbar-link hover-underline">
              ...
              <span class="span">References</span>
            </a>
          </li>
        ...
        <div class="text-center">
          ...
          <address class="body-4">
            1275 Cedar Lane Road Middletown, <br>
            DE 19709 
          </address>

          <p class="body-4 navbar-text">Open: 9:00 am - 10:00pm</p>

          <a href="mailto:garam@gourmé.com" class="body-4 sidebar-link">garam@gourmé.com</a>
      ...
      <section class="section hero" aria-label="home">
        <div class="container">
          ...
          <h1 class="h1 hero-title">
            We are <strong class="strong">Garam Gourmé.</strong> Explore our approach, stories and ideas.
          </h1>
            ...
            <li class="scrollbar-item">
              <div class="blog-card">
                ...
                <figure class="card-banner img-holder" style="--width: 500; --height: 600;">
                  <img src="./assets/images/farm-table-blog.jpg" width="500" height="600" loading="lazy"
                ...
                <div class="card-content">
                  ...
                  <ul class="card-meta-list">
                    ...
                    <li>
                      <a href="#" class="card-tag">Fresh</a>
                    </li>

                    <li>
                      <a href="#" class="card-tag">Local</a>
                    </li>

                    <li>
                      <a href="#" class="card-tag">Flavorful</a>
                    </li>
                  ...
                  <h3 class="h4">
                    <a href="#" class="card-title hover:underline">
                        From Farm to Table: The Freshness Behind Every Bite
                    </a>
                  </h3>

                  <p class="card-text">
                    Explore how Garam Gourme sources its fresh, locally grown vegetables and ingredients directly from nearby farms. 
                  </p>
  ...
  -->
    ...
    style="background-image: url('./assets/images/footerbackground.png')">
     <div class="container">
       ...
       <div class="footer-top grid-list">
         ...
         <div class="footer-brand has-before has-after">
           ...
           <a href="#" class="logo">
             <img src="./assets/images/logos.svg" width="160" height="50" loading="lazy" alt="Garam Gourmé">
           </a>
 
           <address class="body-4">
             1275 Cedar Lane Rd, Middletown, DE 19709
           </address>
 
           <a href="mailto:garam@gourmé.com" class="body-4 contact-link">garam@gourmé.com</a>
 
           <a href="tel:+88123123456" class="body-4 contact-link">Contact Us: +1 123 456 7890</a>
           ...
           <p class="label-1">
             Subscribe us & Get <span class="span">Discounts every week</span>
           </p>
         ...
         <ul class="footer-list">
           ...
           <li>
             <a href="About Us.html" class="label-2 footer-link hover-underline">About Us</a>
           </li>
           ...
           <li>
             <a href="#" class="label-2 footer-link hover-underline">References</a>
           </li>
